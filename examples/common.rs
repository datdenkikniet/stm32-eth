...
#[cfg_attr(feature = "stm32h7xx-hal", link_section = ".sram1.eth")]
static mut RX_DESCRIPTORS: MaybeUninit<[RxDescriptor; NUM_DESCRIPTORS * 2]> = MaybeUninit::uninit();
#[cfg_attr(feature = "stm32h7xx-hal", link_section = ".sram1.eth")]
...
pub fn setup_rings() -> (TxDescriptorRing<'static>, RxDescriptorRing<'static>) {
    ...
    let rx_desc = unsafe { RX_DESCRIPTORS.write([RxDescriptor::new(); NUM_DESCRIPTORS * 2]) };
